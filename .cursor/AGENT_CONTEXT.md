...
*Last consolidated: Control panel POST /api/analytics/control-panel persists toggles (activate_smart_routing, deploy_fraud_shadow_model, recalculate_algorithms) to Lakebase app_settings via write_app_settings_keys. Command Center, package.json pinned versions, dashboards, orchestrator, deploy flow. No open TODO/FIXME in codebase.*
